...
class OffersCrawler extends Amazon
{
    protected function parsePage()
    {
        ...
        $priceElem = trim(optional($this->getElementsByClassName('olpOfferPrice', 'span'))->nodeValue);
        $pricePerUnitElem = trim(optional($this->getElementsByClassName('pricePerUnit', 'span'))->nodeValue);
