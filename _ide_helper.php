 ...
 * Generated for Laravel 7.20.0 on 2020-07-21 09:28:13.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Artisan {
         ...
         * @static 
         */ 
        public static function hourly($schedule)
        {
                        /** @var \App\Console\Kernel $instance */
                        return $instance->hourly($schedule);
        }
         ...
         * @static 
         */ 
        public static function daily($schedule)
        {
                        /** @var \App\Console\Kernel $instance */
                        return $instance->daily($schedule);
        }
         ...
         * @static 
         */ 
        public static function weekly($schedule)
        {
                        /** @var \App\Console\Kernel $instance */
                        return $instance->weekly($schedule);
        }
         ...
         * @static 
         */ 
        public static function monthly($schedule)
        {
                        /** @var \App\Console\Kernel $instance */
                        return $instance->monthly($schedule);
        }
         ...
         * @static 
         */ 
        public static function yearly($schedule)
        {
                        /** @var \App\Console\Kernel $instance */
                        return $instance->yearly($schedule);
        }
         ...
         * @static 
         */ 
        public static function dashboard($schedule)
        {
                        /** @var \App\Console\Kernel $instance */
                        return $instance->dashboard($schedule);
        }
...
namespace Spatie\Dashboard\Facades { 
    ...
    class Dashboard {
        ...
        {
                        /** @var \Spatie\Dashboard\Dashboard $instance */
                        return $instance->script($url);
        }
         ...
         * @static 
         */ 
        public static function inlineScript($script)
        {
                        /** @var \Spatie\Dashboard\Dashboard $instance */
                        return $instance->inlineScript($script);
        }
        ...
        {
                        /** @var \Spatie\Dashboard\Dashboard $instance */
                        return $instance->stylesheet($url);
        }
...
namespace  { 
    ...
    class Dashboard extends \Spatie\Dashboard\Facades\Dashboard {}
